        ...
        return (
            <BlockContentWrapper>
                <Wrapper>
                    ...
                    <p><TextContent size={"1.2rem"}><strong>Cross-platform:</strong> React Native, Cordova, Electron, Crosswalk.</TextContent></p>
                    ...
                    <p><TextContent size={"1.2rem"}><strong>JavaScript Node.js:</strong> Express.js, Next.js.</TextContent></p>
